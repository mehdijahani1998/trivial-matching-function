...
/* package simple-order-mathcing-0.1.0.0 */
#ifndef VERSION_simple_order_mathcing
#define VERSION_simple_order_mathcing "0.1.0.0"
#endif /* VERSION_simple_order_mathcing */
#ifndef MIN_VERSION_simple_order_mathcing
#define MIN_VERSION_simple_order_mathcing(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_simple_order_mathcing */
...
#define CURRENT_PACKAGE_KEY "simple-order-mathcing-0.1.0.0-inplace"
#endif /* CURRENT_PACKAGE_KEY */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "simple-order-mathcing-0.1.0.0-inplace"
